 ...
 */
public final class EntryPluginType<T> implements PluginType<T> {
     ...
     * @since 2.1
     */
    public EntryPluginType(final PluginEntry pluginEntry, final Class<T> pluginClass, final String elementName) {
    ...
    public String toString() {
        return "EntryPluginType [pluginClass=" + pluginClass +
